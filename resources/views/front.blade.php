...
<body >
    ...
    <section class="main__conatiner" style="background-color: #ddd1bf;">
        <header class="header" style="background-color:#ddd1bf;">
            <div class="top__row">
                <div class="site__fix">
                </div>
                <div class="nav__row">
                    <div class="site__fix">
                        <a href="" title="whistleb" class="logo"> <img src="{{asset('asset/images/logos.jpg')}}" alt="whistleb" height="100%"></a>
                        ...
                        <nav>
                            <ul class="menu">
                                ...
                                <li class="menu-item"><a href="#FeedbackForm" title="">Feedback</a></li>
        ...
        <section class="body__conatiner">
            ...
            <section class="expertise"style="background-color: orange;">
            <div id="Aboutwhistleb" >
                <div class="site__fix" style="background-color: orange;">
                    <h2>EXPERTISE</h2>
                    <p class="short__dec" style="font-size: 1.4em;">We are innovators in creative web design in Los Angeles. We don’t play any guessing games, but seek the facts from a range of analytics to help you get the edge.</p>
                    <div class="exp__listing">
                        ...
                        <article class="wow fadeInUp">
                            ...
                            <span class="link"><a href="/discovery/">Explore Services &gt;</a> </span>
                            <div class="expertise__hover">
                                <img src="{{asset('asset/images/expertise/expertise_block-1_hover.')}}'">
                                <div class="inner">
                                    <div class="exp__text">
                                        <h4>Discovery</h4>
                                        <ul>
